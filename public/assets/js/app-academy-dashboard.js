...
(function () {
  ...
  const horizontalBarChartEl = document.querySelector('#horizontalBarChart1'),
    horizontalBarChartConfig = {
      ...
      labels: ['Décembre', 'Novembre', 'Octobre', 'Septembre', 'Août', 'Juillet', 'Juin', 'Mai', 'Avril', 'Mars', 'Février', 'Janvier'],
      series: [
        {
          data: [35, 20, 14, 12, 10, 9,20, 10, 14, 25, 19, 9]
        }
      ],

      xaxis: {
        categories: ['Décembre', 'Novembre', 'Octobre', 'Septembre', 'Août', 'Juillet', 'Juin', 'Mai', 'Avril', 'Mars', 'Février', 'Janvier'],
        axisBorder: {
          show: false
        },
        axisTicks: {
  ...
  // bar chart 1 
  const horizontalBarChartEl1 = document.querySelector('#horizontalBarChartFb'),
...
if (typeof horizontalBarChartEl1 !== undefined && horizontalBarChartEl1 !== null) {
  const horizontalBarChart1 = new ApexCharts(horizontalBarChartEl1, horizontalBarChartConfig1);
  horizontalBarChart1.render();
}

  // bar chart 2
  const horizontalBarChartEl2 = document.querySelector('#horizontalBarChart2'),
...
if (typeof horizontalBarChartEl2 !== undefined && horizontalBarChartEl2 !== null) {
  const horizontalBarChart2 = new ApexCharts(horizontalBarChartEl2, horizontalBarChartConfig2);
