<template>
    <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
        <a class="nav-link dropdown-toggle hide-arrow btn-top" href="javascript:void(0);" data-bs-toggle="dropdown"
        ...
        <ul class="dropdown-menu dropdown-menu-end notificationBox py-0">
            ...
            <li class="dropdown-notifications-list scrollable-container">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item list-group-item-action dropdown-notifications-item"  v-for="item in notifications" :key="item.id">
                        <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar">
                                    <div class="icon" v-html="getIcon(item.type)"></div>
                                </div>
                            </div>
...
export default {
    data() {
        return {
            notifications: [
                { 'title': 'Nom prénom 1 a ajouté son daily', 'time': 'Il y a 2h', 'date': '10/01/2025', 'type': 'daily' },
                { 'title': 'Rappel Rendez-vous avec client 1', 'time': 'Dans 30 min', 'date': '10/01/2025', 'type': 'rendezVous' },
                { 'title': 'Projet 1 : tâche terminé', 'time': 'Dans 30 min', 'date': '10/01/2025', 'type': 'task' },
                { 'title': 'Nom prénom 2 a demandé un congé', 'time': 'Il y a 2h', 'date': '10/01/2025', 'type': 'conge' },
            ],
            icons: {
