...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="description">Vous recevez cet email car nous avons reçu une demande de réinitialisation de mot de passe pour votre compte.</p>
            ...
            <p class="help-text">Si vous n'avez pas demandé de réinitialisation de mot de passe, aucune action n'est requise.</p>
